...
def shape_broadcast(shape1: UserShape, shape2: UserShape) -> UserShape:
    ...
    shape1_padded = (1,) * (max_len - len(shape1)) + tuple(shape1)
    shape2_padded = (1,) * (max_len - len(shape2)) + tuple(shape2)
...
class TensorData:
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        """Convert a user-friendly index to a linear index in storage.
        ...
        Returns:
        -------
            int: The linear index in storage.
    ...
    def permute(self, *order: int) -> TensorData:
        ...
        new_strides = [self._strides[o] for o in order]
